...
#ifndef ATECAT_ARCHSTR
#define ATECAT_ARCHSTR "armv7-eabihf"
#endif
#ifndef EC_ARCH
#define EC_ARCH EC_ARCH_ARM
#endif
...
#if (__riscv_xlen == 64)
#ifndef ATECAT_ARCHSTR
#define ATECAT_ARCHSTR  "riscv64"
#endif
#ifndef EC_ARCH
#define EC_ARCH EC_ARCH_RISCV64
#endif
#endif
#endif
#endif /* riscv */
...
#ifndef OsPlatformReleaseLinkLayerRegFunc
#define OsPlatformImplReleaseLinkLayerRegFunc OsPlatformImplReleaseLinkLayerRegFunc
#define OsPlatformReleaseLinkLayerRegFunc     OsPlatformImplReleaseLinkLayerRegFunc
#endif
...
#define OsPlatformResetEvent(pvEvent)  sem_trywait((sem_t*)(pvEvent))
  ...
  #define OsPlatformMemoryBarrier()     {__asm__ __volatile__ ("lock; addl $0,0(%%rsp)" : : : "memory");}
  ...
  #define OsPlatformMemoryBarrier()     {__asm__ __volatile__ ("dsb sy" : : : "memory");}
#else
